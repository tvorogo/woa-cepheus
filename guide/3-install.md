...
- [Drivers & UEFI](https://github.com/qaz6750/XiaoMi9-Drivers/releases/latest) (make sure you select the **.img** file that has **SB** or **SecureBoot** in the name. Do NOT select **NOSB**.)
